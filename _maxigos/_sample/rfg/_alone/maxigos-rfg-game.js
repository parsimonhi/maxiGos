...
{
	if(this.backToGameBtnOn)this.addBtnClickListener("BackToGame");
}
mxG.G.prototype.createBackToGame=function()
{
	...
	return this.backToGameBtnOn?this.createBtn("BackToGame","Back to game"):"";
}
}
...
mxG.D[mxG.K].a.concatInHeader="DateToTitle,KomiToResult,HandicapToResult";
