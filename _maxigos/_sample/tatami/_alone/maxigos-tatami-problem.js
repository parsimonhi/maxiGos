...
mxG.D[mxG.K].style4Problem=".mxTatamiTheme.mxProblemConfig{& .mxSolveBox{text-align:center;}& .mxSolveBox button{width:min(33%,3.3em);margin:min(6.6%,0.66em);padding:0;border:0;background:none;}& .mxSolveBox button svg{width:100%;height:100%;}& .mxSolveBox button:focus circle,& .mxSolveBox button:focus rect,& .mxSolveBox button:focus path{fill:#f00;}}";
