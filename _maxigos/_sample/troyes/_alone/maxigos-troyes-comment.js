// maxiGos v8 Troyes+Comment copyright 1998-2024 FM&SH, BSD license
...
mxG.K++;
mxG.B=["Goban","Navigation","Variation","Comment","Header"];
...
mxG.D[mxG.K].style4Comment=".mxTroyesTheme.mxCommentConfig{& .mxCommentBox{height:7em;padding:0.25em;border:1px solid rgba(0,0,0,0.3);overflow:auto;resize:vertical;}& .mxCommentBox:focus{border:1px solid rgba(0,0,0,0.7);color:rgba(0,0,0,0.9);}}";
