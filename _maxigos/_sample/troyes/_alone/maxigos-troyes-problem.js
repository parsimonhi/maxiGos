// maxiGos v8 Troyes+Problem copyright 1998-2024 FM&SH, BSD license
...
mxG.D[mxG.K].style4Problem=".mxTroyesTheme.mxProblemConfig{& .mxCommentBox{display:flex;justify-content:center;min-height:2.25em;border:1px solid #0000;margin-bottom:1px;}& .mxCommentContent p{margin:0.5em;padding:0;line-height:1.25em;}& .mxSolveBox{text-align:center;}& .mxSolveBox button{width:min(33%,3.3em);margin:min(6.6%,0.66em);padding:0;border:0;background:none;}& .mxSolveBox path{fill:rgba(0,0,0,0.9);}& .mxSolveBox button:focus path{fill:#b30;}}";
