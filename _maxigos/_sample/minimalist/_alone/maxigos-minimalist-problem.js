// maxiGos v8 Minimalist+Problem copyright 1998-2023 FM&SH, BSD license
...
mxG.D[mxG.K].style4Problem=".mxMinimalistTheme.mxProblemConfig .mxCommentDiv{display:flex;justify-content:center;min-height:2.25em;}.mxMinimalistTheme.mxProblemConfig .mxCommentContentDiv p{margin:0.5em;padding:0;line-height:1.25em;}.mxMinimalistTheme.mxProblemConfig .mxSolveDiv{text-align:center;}.mxMinimalistTheme.mxProblemConfig button{border:0;background:none;margin:0.125em 1em;padding:0;width:10%;min-width:1cm;height:auto;}";
