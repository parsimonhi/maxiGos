...
mxG.D[mxG.K].style4Problem=".mxMinimalistTheme.mxProblemConfig{& .mxSolveBox{text-align:center;}& .mxSolveBox button{width:min(33%,3.3em);margin:min(6.6%,0.66em);padding:0;border:0;background:none;}& .mxCommentBox{display:flex;justify-content:center;min-height:2.25em;}& .mxCommentContent p{margin:0.5em;padding:0;line-height:1.25em;}}";
