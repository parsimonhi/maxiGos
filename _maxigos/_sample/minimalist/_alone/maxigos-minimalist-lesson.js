// maxiGos v8 Minimalist+Lesson copyright 1998-2024 FM&SH, BSD license
...
{
	let cw,s="<svg xmlns='"+this.xmlnsUrl+"' xmlns:xlink='"+this.xlinkUrl+"'";
...
{
	let cb,cw,s="<svg xmlns='"+this.xmlnsUrl+"' xmlns:xlink='"+this.xlinkUrl+"'";
	s+=" viewBox='0 0 160 112' stroke-linecap='square'>";
	if(this.p.in3dOn)
	{
...
mxG.D[mxG.K].style4Lesson=".mxMinimalistTheme.mxLessonConfig>div:first-of-type{align-self:end;}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv{box-sizing:border-box;position:relative;margin:0 auto 0.25em auto;width:100%;}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv>:first-child{position:absolute;z-index:1;bottom:120px;left:10%;right:10%;border-radius:1.5em;font-family:\"Chalkboard SE\",\"Comic Sans MS\",sans-serif;background-color:#fff;text-align:center;}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv>img{display:block;margin:0 auto;}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv>:first-child:empty{display:none;}.mxMinimalistTheme.mxLessonConfig.mxIn3d .mxLessonDiv>:first-child{padding:8px 8px 8px 12px;box-shadow:4px 4px 12px #0007;}.mxMinimalistTheme.mxLessonConfig.mxIn2d .mxLessonDiv>:first-child{padding:8px;border:var(--border);}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv.mxTE>:first-child,.mxMinimalistTheme.mxLessonConfig .mxLessonDiv.mxBM>:first-child{margin-left:2.25em;min-height:2.25em;}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv.mxTE>:first-child::before,.mxMinimalistTheme.mxLessonConfig .mxLessonDiv.mxBM>:first-child::before{background-repeat:no-repeat;background-position:left center;background-size:2em;display:block;height:2em;width:2em;content:\"\";position:absolute;top:0.25em;left:0.25em;}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv.mxTE>:first-child::before{background:url(\'data:image/svg+xml;utf8,<svg width=\"100%\" height=\"100%\" viewBox=\"0 0 128 128\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\"><circle fill=\"none\" stroke=\"black\" stroke-width=\"4\" cx=\"64\" cy=\"64\" r=\"48\"/><circle fill=\"black\" cx=\"48\" cy=\"48\" r=\"8\"/><circle fill=\"black\" cx=\"80\" cy=\"48\" r=\"8\"/><path fill=\"none\" stroke=\"black\" stroke-width=\"4\" d=\"M44,78A32 32 0 0 0 84,78\"/></svg>\');}.mxMinimalistTheme.mxLessonConfig .mxLessonDiv.mxBM>:first-child::before{background:url(\'data:image/svg+xml;utf8,<svg width=\"100%\" height=\"100%\" viewBox=\"0 0 128 128\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\"><circle fill=\"none\" stroke=\"black\" stroke-width=\"4\" cx=\"64\" cy=\"64\" r=\"48\"/><circle fill=\"black\" cx=\"48\" cy=\"48\" r=\"8\"/><circle fill=\"black\" cx=\"80\" cy=\"48\" r=\"8\"/><path fill=\"none\" stroke=\"black\" stroke-width=\"4\" d=\"M44,86A32 32 0 0 1 84,86\"/></svg>\');}";
